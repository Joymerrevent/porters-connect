...
export function resourceCategory(code: number): ErrorCategory {
...
export function authCategory(code: number): ErrorCategory {
...
function resourceHint(code: number): string | undefined {
  if (code === 403)
...
export function authError(code: number, message: string): PortersAuthError {
...
export function networkError(
  ...
  return new PortersNetworkError(message, {
    category: "network",
    retryable: true,
    cause,
  });
