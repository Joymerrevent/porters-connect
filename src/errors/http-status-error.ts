// HTTP status -> category, and the error for a response whose body is not a PORTERS envelope
// (ADR-0044): the reference calls an error "HTTP != 200 *or* <Code> != 0", and this is the HTTP half.
