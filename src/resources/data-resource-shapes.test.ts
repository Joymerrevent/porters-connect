...
import type { DataResource } from "../accessor/data-resource";
import type { Without } from "../util/types";
import type { EmptyReferences, ReferenceMap } from "../accessor/expand";
import type { EmptyCatalog, FieldCatalog } from "../accessor/catalog";
import {
  ACTIVITY_DESCRIPTOR,
