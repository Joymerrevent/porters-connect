// Sales accessor (ADR-0004/0005/0011/0019): built on the data resources' factory
// (`createDataResource`), which gives every data resource the same methods. Only the Data-Type
// catalog and names are Sales-specific; the static Sales / input types derive from the catalog
// (ADR-0019). Sales ties the whole chain together — it references Client, Recruiter, Job, Contract,
// Candidate and Resume, and every one of them is expandable (ADR-0058).
//
