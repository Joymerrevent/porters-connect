// Candidate accessor (ADR-0004/0005/0011/0019): built on the data resources' factory
// (`createDataResource`), which gives every data resource the same methods. Only the Data-Type
// catalog and names are Candidate-specific; the static Candidate / input types derive from the
// catalog (single source of truth — ADR-0019).
