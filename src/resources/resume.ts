// Resume accessor (ADR-0004/0005/0011/0019): built on the data resources' factory
// (`createDataResource`), which gives every data resource the same methods. A Resume belongs to a
// Candidate; P_Candidate is System[Reference] (Write = the Person id).
//
...
// The static Resume / input types derive from the catalog (ADR-0019).
