...
//     heading (MD041).
//   - `docs/api/*` — TypeDoc output (ADR-0068). It is inline-link Markdown throughout, which MD054
...
// (verified), and `docs/api` is listed there. Formatting the generated files would make them differ
...
const isGeneratedApiDoc = inDir("docs/api");
