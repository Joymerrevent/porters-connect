...
| [RV-55][rv55] | 🟢     | API 忠実性 / フェイルセーフ     | open    | `decodeTimeOfDay` が 1 日目の時 24〜47・分秒 60 以上を弾かず、別の wire 値に往復する |
| [RV-56][rv56] | 🟢     | ドキュメント / プロセス         | open    | ADR 索引の「実装」列が 0.8.0 以降更新されず、凡例が 21 本で事実と食い違う            |
| [RV-57][rv57] | 🟢     | プロセス / ドキュメント         | open    | RV-54 で保留した書き込み側の判断が ADR バックログにも roadmap にも無い               |
