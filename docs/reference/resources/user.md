...
- endpoint: `/v1/user`
- scope: `user_r`
- 出典: <https://hrbcapi.porters.jp/hc/ja/articles/360001264748-User-Field-List-Timezone-List>（updated_at 2025-02-14、取得 2026-06-12）
...
| Alias                   | Name               | Data Type          | Definition                                                                                                                                             |
| ----------------------- | ------------------ | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
