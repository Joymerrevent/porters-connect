...
| Opportunity.P_Client           | 企業             | System[Reference] | ●        | ー       | 関連するClient（企業）を表します。 / Readの場合、Client ResourceのFieldを参照することができます。 / Writeの場合、Client.P_Idの値のみを指定することができます。                |
...
| Opportunity.P_Phase            | フェーズ         | Option[Dropdown]  | ー       | ー       | 選択肢：Option.P_OpportunityPhase / 注意事項はWrite API - Phaseの更新についてを参照してください。                                                                             |
