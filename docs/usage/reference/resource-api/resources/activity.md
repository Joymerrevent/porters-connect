...
| Activity.P_Phase             | フェーズ                 | Option[Dropdown]  | ー       | ー       | 選択肢：Option.P_ActivityPhase / 注意事項はWrite API - Phaseの更新についてを参照してください。                                                                                                                                                                       |
...
| Activity.P_EventResources    | リソース                 | Option[Checkbox]  | ー       | ー       | 選択肢：Option.P_EventResources                                                                                                                                                                                                                                      |
