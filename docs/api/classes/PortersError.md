...
[@joymerrevent/porters-connect](../index.md) / PortersError
...
- [`PortersAuthError`](PortersAuthError.md)
- [`PortersResourceError`](PortersResourceError.md)
- [`PortersNetworkError`](PortersNetworkError.md)
- [`PortersConfigError`](PortersConfigError.md)
