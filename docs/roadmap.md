...
品質ゲートは全 green（**881 tests**・coverage は perFile 100%）。
...
| V2  | **使い方のドキュメント完成**           | 「入門（順に読む）→ 考え方 → 目的別 HOWTO」が揃い、**読者の目的から引ける**こと。検査は [ADR-0070][adr70] の 4 つ                          | **達成**（4 層 ＋ 検査①〜④ ＋ README を入口に絞る ＋ `docs/usage/` への集約） |
