...
| V2  | **使い方のドキュメント完成**           | 「入門（順に読む）→ 考え方 → 目的別 HOWTO」が揃い、**読者の目的から引ける**こと。検査は [ADR-0070][adr70] の 4 つ                          | 構成・骨組み・検査①④は済／**入門と考え方が未着手** |
...
- [ ] **使い方のドキュメント（V2）** — [ADR-0070][adr70]（accepted）に沿って進行中。3 本に分けた。
  ...
  - [ ] **B: 入門 5 本と考え方 4 本を書く**（`start/` と `concepts/` の残り）＝ V2 の主要な残作業
