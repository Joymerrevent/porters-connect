...
Department は同日に実装して **V1 は再び達成**、残るのは時分型の ADR 1 件:
...
| V3  | **自分で進められる作業が残っていない** | 本書の「着手可能」「判断待ち」「要 ADR」がすべて 0 件 ／ [findings][findings] の open が 0 件                                              | 着手可能 0・判断待ち 0・要 ADR **1**（時分型・2026-09-20 起票）・open 0（README 英語版は `1.0.0` の後へ）                                                                  |
...
| ----------------------------- | -------------------------------------------------- | ------------------------------------------------------ |
| **本書**（roadmap）           | **次に何をやるか**（着手可能 / 判断待ち / 要 ADR） | 着手可能 0・判断待ち 0・要 ADR 1（時分型・2026-09-20） |
