...
- [ ] **リソースの共通の仕組みを `src/accessor/` に移す**（[ADR-0101][adr101]・2026-09-26 accepted・stakeholder の議論）。
...
| [docs/adr][adr]               | 【accept 済み・実装済み】＋論点バックログ          | decide 待ち 0 件・**反映待ち 1 件**（[ADR-0101][adr101] の実装） |
